...
class InvestorDetails extends Component {
  ...
  componentDidMount(){
    ...
    console.log(id)
    console.log('TEST investor details')
  }
  ...
  render() {
    const {email,city} = this.props.contact;
    ...
    <div class="form-group">
      ...
      <div className="col-sm-5" id="IN6">
            ...
            <div class="form-group">
                      ...
                      <input type="email" className="form-control form-control-sm" id="contactnumber" aria-describedby="emailHelp" onChange={this.onChange} name='email' value={this.props.contact.email}/>
              </div>
...
<div className="container">
      <div className="row" style={{float:'right'}}>
        <div id="IN8">
            ...
            <button type="submit" id="btndiv" style={{backgroundColor:'powderblue'}} onClick={this.onSubmit}>
            <i className="fas fa-pencil-alt" id="icon1">  </i>Update
            </button>
            <div id="btndiv" style={{backgroundColor:'red'}}><i className="far fa-trash-alt" id="icon1" onClick={() => console.log('Hello from Delete Button')}></i><p>Delete</p></div>
        </div>  
      </div>
</div>
